...
<%--         <script>
    ...
    <body class="bg-primary">
                                    ...
                                    <div class="card-body">
                                        <form action="<%=request.getContextPath() %>/loginProcess.do" method="post">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" autocomplete="off" "inputEmailAddress" type="text" name="id" placeholder="Enter ID" />
                                            </div>
                                            <div class="form-group">
        ...
        <script src="<%=request.getContextPath()%>/dist/js/scripts.js"></script>
        <script>
