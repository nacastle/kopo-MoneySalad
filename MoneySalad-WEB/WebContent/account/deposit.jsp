...
<%-- 			현재 잔액 : ${balance } 원 --%>
			...
			<div class="form-group">
    		  <label for="exampleInputEmail1">입금할 금액</label>
     		 <input type="number" name="depositAmount" style="width: 20%" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="">
     		 <small id="emailHelp" class="form-text text-muted">입금하실 금액을 입력해주세요.</small>	<p class="text-info"><i>현재 잔액 : ${balance } 원</i></p>
  		  </div>
...
<!-- 			<button type="button" class="btn btn-outline-primary">Primary</button> -->
			...
			<input class="btn btn-outline-primary" style="margin-left: 2%" type="submit" value="입금">
		</form>
